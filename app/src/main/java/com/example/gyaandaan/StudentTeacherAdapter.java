...
public class StudentTeacherAdapter extends RecyclerView.Adapter<StudentTeacherAdapter.MyViewHolder>  {
    ...
    String sender;
    public StudentTeacherAdapter(Context context, ArrayList<Teacher2> list,String sender) {
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
        ...
        holder.name.setText(t1.getStudent_name());
        ...
        holder.contact.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Log.d("TAG", "** Message class called from your stdeunts");

                intent.putExtra("sender",sender);
                intent.putExtra("receiver",t1.getStudent_name());
